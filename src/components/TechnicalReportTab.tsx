...
interface TechnicalReportTabProps {
  programCode: string;
}

const TechnicalReportTab = ({ programCode }: TechnicalReportTabProps) => {
  return (
      ...
      <div className="bg-white p-6 rounded-md shadow-sm border border-gray-100">
        <div className="mb-4">
          ...
          <div className="p-4 bg-gray-100 flex items-center hover:bg-gray-200 transition-colors cursor-pointer">
            ...
            <span className="text-gray-800">AACCUP Technical Report.pdf</span>
          </div>
        </div>
      </div>
    </TabsContent>
...
export default TechnicalReportTab;
