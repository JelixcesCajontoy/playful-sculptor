      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="prose max-w-none">
          <p className="text-lg mb-6">
            The BS in Criminology program at Cavite State University - Bacoor City Campus 
            prepares students for careers in law enforcement, criminal investigation, and the justice system.
          </p>
          <p className="text-lg mb-6">
            Our program provides a comprehensive understanding of criminal behavior, law enforcement procedures,
            forensic techniques, criminal law, and the criminal justice system.
          </p>
          <h2 className="text-2xl font-semibold text-primary mt-8 mb-4">Program Outcomes</h2>
          <ul className="list-disc pl-6 mb-6">
            <li className="mb-2">Develop knowledge of criminal law and procedure</li>
            <li className="mb-2">Understand crime causation and criminal behavior</li>
            <li className="mb-2">Apply investigation and forensic techniques</li>
            <li className="mb-2">Analyze evidence and prepare legal documentation</li>
            <li className="mb-2">Prepare for careers in law enforcement, investigation, and the criminal justice system</li>
          </ul>
        </div>
      </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-white/80 text-sm">
                {departments.map((dept) => (
                  <li key={dept.name}>
                    <button 
                      onClick={() => handleProgramClick(dept.programs[0])}
