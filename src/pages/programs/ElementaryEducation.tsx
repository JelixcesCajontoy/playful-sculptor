      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="prose max-w-none">
          <p className="text-lg mb-6">
            The Bachelor in Elementary Education program at Cavite State University - Bacoor City Campus 
            prepares students to become competent elementary school teachers with a strong foundation in educational theory and practice.
          </p>
          <p className="text-lg mb-6">
            Our program focuses on child development, teaching methodologies, curriculum design, and assessment strategies
            specific to elementary education. Students also gain hands-on experience through teaching practicum.
          </p>
          <h2 className="text-2xl font-semibold text-primary mt-8 mb-4">Program Outcomes</h2>
          <ul className="list-disc pl-6 mb-6">
            <li className="mb-2">Develop effective teaching strategies for elementary education</li>
            <li className="mb-2">Understand child development and learning theories</li>
            <li className="mb-2">Design and implement age-appropriate curriculum</li>
            <li className="mb-2">Apply assessment techniques to evaluate student learning</li>
            <li className="mb-2">Prepare for licensure and careers in elementary education</li>
          </ul>
        </div>
      </div>
