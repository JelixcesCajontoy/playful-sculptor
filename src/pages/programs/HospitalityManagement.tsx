      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="prose max-w-none">
          <p className="text-lg mb-6">
            The BS in Hospitality Management program at Cavite State University - Bacoor City Campus 
            prepares students for careers in the hotel, restaurant, tourism, and events management industries.
          </p>
          <p className="text-lg mb-6">
            Our program combines theoretical knowledge with practical skills in hotel operations, 
            food and beverage service, event planning, tourism management, and customer service excellence.
          </p>
          <h2 className="text-2xl font-semibold text-primary mt-8 mb-4">Program Outcomes</h2>
          <ul className="list-disc pl-6 mb-6">
            <li className="mb-2">Develop skills in hotel and restaurant operations</li>
            <li className="mb-2">Understand tourism and event management principles</li>
            <li className="mb-2">Apply customer service excellence in hospitality settings</li>
            <li className="mb-2">Manage food and beverage services effectively</li>
            <li className="mb-2">Prepare for careers in hotels, restaurants, tourism, and event management</li>
          </ul>
        </div>
      </div>
