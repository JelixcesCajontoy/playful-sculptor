    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <ProgramTabs>
          ...
          <ExtensionTab programCode="SEC" />
          <FacultyTab programCode="SEC" />
          <LibraryTab programCode="SEC" />
          <ComplianceReportTab />
          <WorkingChecklistTab programCode="SEC" />
          <TechnicalReportTab programCode="SEC" />
          <RequestedDocumentsTab programCode="SEC" />
        </ProgramTabs>
      </div>
