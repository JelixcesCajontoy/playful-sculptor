      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="prose max-w-none">
          <p className="text-lg mb-6">
            The Bachelor in Secondary Education program at Cavite State University - Bacoor City Campus 
            prepares students to become effective high school teachers with specialized knowledge in their teaching subjects.
          </p>
          <p className="text-lg mb-6">
            Our program combines content mastery in specific subject areas with advanced teaching methodologies, 
            adolescent psychology, classroom management, and educational technology skills.
          </p>
          <h2 className="text-2xl font-semibold text-primary mt-8 mb-4">Program Outcomes</h2>
          <ul className="list-disc pl-6 mb-6">
            <li className="mb-2">Develop expertise in specific subject areas for secondary education</li>
            <li className="mb-2">Understand adolescent development and learning needs</li>
            <li className="mb-2">Apply effective teaching strategies for secondary students</li>
            <li className="mb-2">Integrate technology into the teaching-learning process</li>
            <li className="mb-2">Prepare for licensure and careers in secondary education</li>
          </ul>
        </div>
      </div>
